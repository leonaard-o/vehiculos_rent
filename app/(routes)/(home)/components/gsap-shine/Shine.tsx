...
const ShineImage: React.FC<ShineImageProps> = ({
  src,
  alt,
  width = 200,
  height = 200,
    ...
    >
      <div className=" flex items-center justify-center lg:w-full  shadow-[0_0_25px_12px_rgba(0,0,0,0.25)] ">
        ...
        <Image
          ...
          width={width}
          height={height}
          className="rounded-3xl h-[8em] lg:h-[15em] object-cover   hover:shadow-xl hover:brightness-110 lg:w-full"
        />
